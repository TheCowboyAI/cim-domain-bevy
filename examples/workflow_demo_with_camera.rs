//! Workflow Demo with Camera Controls
//!
//! Use mouse to pan and zoom the camera to see the entire workflow.
...
fn setup(
    ...
    // Remove the text labels section - Text2d doesn't work well in 3D space
